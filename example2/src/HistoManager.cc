...
{ 
  ...
  //
  G4String fileName = "example2.root";
  ...
  // id = 0
  fHisto[0] = new TH1D("Ener", "energy of pions in scoring volume ", 100, 0., 800*CLHEP::MeV);
  // id = 1
  fHisto[1] = new TH1D("Mome", "momentum of pions  in scoring volume", 100, 0., 100*CLHEP::MeV);
  // id = 2
  ...
  // create 1st ntuple
  fNtuple1 = new TTree("Ntuple1", "Ener");
  fNtuple1->Branch("Ener", &fEner, "Ener");


  //create 2nd ntuple
  fNtuple2 = new TTree("Ntuple2", "Mome");
  fNtuple2->Branch("Mome", &fMome, "Mome");
...
void HistoManager::FillNtuple(G4double Trackenergy, G4double Trackmomentum)
{
  fEner = Trackenergy;
  fMome = Trackmomentum;
...
void HistoManager::PrintStatistic()
{
  ...
  for ( G4int i=0; i<kMaxHisto; ++i ) {
    ...
    if (name[0] == 'M' ) unitCategory = "Momentum";
